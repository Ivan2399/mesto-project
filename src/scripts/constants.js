...
export const nameInput = profileForm.querySelector('.popup__input-item_type_name');
export const jobInput = profileForm.querySelector('.popup__input-item_type_profession');

...
const formEditElement = popupEdit.querySelector(".popup__forms");
const nameInput = formEditElement.querySelector(".popup__item_type_name");
const jobInput = formEditElement.querySelector(".popup__item_type_hobby");
...
function submitEditHandler(evt) {
  evt.preventDefault();
...
formEditElement.addEventListener("submit", submitHandler);

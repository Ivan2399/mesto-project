...
function createCard(link, name) {
    const cardElement = cardTemplate.querySelector('.table__card').cloneNode(true);
    cardElement.querySelector('.table__image').src = link;
    cardElement.querySelector('.table__image').alt = name;
    cardElement.querySelector('.table__title').textContent = name;
  ...
  function openCardImage(cardElement) {
    cardElement.querySelector('.table__image').addEventListener('click', function () {
      openPopup(popupOpenImage);
      popupImage.src = cardElement.querySelector('.table__image').src;
      popupImage.alt = cardElement.querySelector('.table__image').textContent;
      popupImageTitle.textContent = cardElement.querySelector('.table__title').textContent;
    }); 
  }
  
  function likeCard(cardElement) {
    cardElement.querySelector('.elements__like').addEventListener('click', function (evt) {
      evt.target.classList.toggle('table__like_active');
    }); 
  }
  
  function deleteCard(cardElement) {
    cardElement.querySelector('.table__delete').addEventListener('click', function (evt) {
      cardElement.remove();
    });
  }

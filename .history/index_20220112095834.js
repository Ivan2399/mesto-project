...
function submitCard (link,name) {
    const cardItem = cardtemplate.querySelector("table__card").cloneNode(true);
    cardItem.querySelector(".").src = link;
    cardItem.querySelector(".").alt = name;
    cardItem.querySelector(".").textContent = name;
}

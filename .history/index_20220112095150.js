...
let popupAddCardNameInput = formAddElement.querySelector(".popup__item_type_card-name");
let popupAddCardLinkInput = formAddElement.querySelector(".popup__item_type_card-link");
let popupAddExitButton = popupAdd.querySelector(".popup__close");
// попап открытия картинки
let popupImageOpen = document.querySelector("#images");
let popupImage = popupImageOpen.querySelector(".popup__image");
let popupImageTitle = popupImageOpen.querySelector(".popup__image-title");

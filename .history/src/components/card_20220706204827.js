...
class Card {
  constructor(
    { data, handleCardClick, likeCard, deleteCard, userId, createCard },
    selector
  ) {
    this.data = data;
  ...
  _generate() {
    this.cardImage = this.cardElement.querySelector(config.card.cardElementsImage);
    this.cardLikeButton = this.cardElement.querySelector(config.card.cardElementsLikeButton);
    this.cardLikeCounter = this.cardElement.querySelector(config.card.cardElementsLikeCounter);
    this.cardDeleteButton = this.cardElement.querySelector(config.card.cardElementsDeleteButton);

    this.cardImage.src = this.data.link;
    this.cardImage.alt = this.data.name;

    this.cardElement.id = this.data._id;
    this.cardElement.querySelector(config.card.cardElementsTitle).textContent = this.data.name;

    if (this._myLike()){
        this.cardLikeButton.classList.add(config.card.cardElementLikeActive);
    }
  }
  createCard() {
